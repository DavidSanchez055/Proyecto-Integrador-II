const RestModel = require("../models/RestaurantsModels");
const {CreateRestaurant: CreateUser, FindAllRestaurant: FindAllUser, FindOneRestaurant: FindOneUser, FindOneRestaurantId: FindOneUsername, deleteRestaurant: deleteUser, updateRestaurant: updateUser} = require("../repository/RestaurantsRepository");
const bcrypt = require("bcrypt-nodejs");

async function create(req, res){
    const params = req.body;

    const regions = new RegionsModels();
    ...
    bcrypt.hash(params.password, null, null, async function (err, hash){
        if(hash){
            regions.nombres =  params.nombres;
            regions.id =  params.id;
            regions.img =  params.img;
